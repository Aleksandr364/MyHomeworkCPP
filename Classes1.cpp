...
{
	// создание экземпл€ра (объекта) класса Phone_Book_Item
	// слева - класс Phone_Book_Item, справа - им€ нового объекта phone_book

	// вызываетс€ конструктор "по умолчанию"
	...
	// вызываетс€ параметрический конструктор
	// создаЄтс€ стэковый объект (локальна€ пам€ть функции) 
